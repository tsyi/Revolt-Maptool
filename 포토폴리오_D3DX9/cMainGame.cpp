	...
	/*
		{
			...
			planeName = "바닥";
			{
				...
				pPlaneUserData.RaycastClosestShape = NX_FALSE;
			...
			TestName = std::string("박스");
			{
				...
				pMeshTextUserData.RaycastClosestShape = NX_FALSE;
			...
			TeapotTr.VectorToQuaternion(D3DXVECTOR3(1, 2, 0), true, true);
			pTeapotActor = NULL;
			TeapotName = std::string("티포트");
			{
				...
				NxF32 mtl[9];
				D3DXMATRIXA16 matMesh = TeapotTr.GetMatrix();
				mtl[0] = matMesh._11;
				mtl[1] = matMesh._12;
				mtl[2] = matMesh._13;
				mtl[3] = matMesh._21;
				...
				pTeapotUserData.RaycastClosestShape = NX_FALSE;
...
void cMainGame::SetUI()
{
	...
	UIWindowR->SetPosition(APIWidth, 0, 0);
	...
	//List
	{
		...
		UITextBox_TextT->SetPosition(1100, 0, 0);
		UITextBox_TextT->SetSize(150, 20);
...
void cMainGame::Render()
{
	...
	/*	D3DMATERIAL9 material;
		...
		MgrD3DDevice->SetTransform(D3DTS_WORLD, &TeapotTr.GetMatrix());
		MgrD3DDevice->SetMaterial(&material);
		MgrD3DDevice->SetTexture(0, NULL);
		...
		MgrD3DDevice->SetTransform(D3DTS_WORLD, &carTr.GetMatrix());
		pMeshCarTest->Render();
	*/
