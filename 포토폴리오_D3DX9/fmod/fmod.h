...
#define FMOD_INIT_DISABLEDOLBY               0x00100000 /* Wii / 3DS - Disable Dolby Pro Logic . Speakermode will be set to STEREO even if user has selected surround in the system settings. */
